...
$limit = 6;
$offset = ($page - 1) * $limit;
list($count) = $db->first('SELECT COUNT(id) from real_estates JOIN real_estate_user ON real_estates.id=real_estate_user.real_estate_id WHERE real_estate_user.user_id=' . $_SESSION['user_id']);
$maxPage = ceil($count / $limit);

$records = $db->fetch('SELECT * from real_estates JOIN real_estate_user ON real_estates.id=real_estate_user.real_estate_id WHERE real_estate_user.user_id=' . $_SESSION['user_id'] . ' ORDER BY real_estates.created_at ' . strtoupper($sort_by_date) . ' LIMIT ' . $limit . ' OFFSET ' . $offset);
?>
<!-- ======= Intro Single ======= -->
    ...
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single">Любими</h1>
