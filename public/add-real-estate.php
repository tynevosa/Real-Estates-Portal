...
$levelTypes = $db->fetch('SELECT * from real_estate_level');
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($missingFields)) {
        ...
        $estateId = $db->insert('real_estates', $newEstate);
        if (!$estateId) {
    ...
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single">Добави Нов Имот</h1>
        </div>
      </div>
      <div class="col-md-12 col-lg-4">
        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="my-real-estates.php">Мойте Имоти</a>
            </li>
                ...
                <div class="form-comments">
                    ...
                    <form class="form-a" method="post" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="col-md-4 mb-3">
                            <div class="form-group">
                              <label for="inputConstructionType">Тип строеж*</label>
                              <select type="text" class="form-control form-control-lg form-control-a <?= in_array('construction', $missingFields) ? 'is-invalid' : '' ?>" id="inputConstructionType" name="construction" <?= isset($constructionId) ? 'value="' . $constructionId . '"' : '' ?> required>
                                ...
                                ?>
                                <option value="<?= $constructionType['id']?>" <?php if (isset($constructionId) && $typeId == $constructionType['id']) {
                                    ?> selected <?php
                          ...
                          <div class="col-md-4 mb-3">
                            <div class="form-group">
                              <label for="inputLevelType">Завършеност*</label>
                              <select type="text" class="form-control form-control-lg form-control-a <?= in_array('level', $missingFields) ? 'is-invalid' : '' ?>" id="inputLevelType" name="level" <?= isset($levelId) ? 'value="' . $levelId . '"' : '' ?> required>
                                <option selected disabled>Избери</option>
                                <?php
                                    foreach ($levelTypes as $levelType) {
                                ?>
                                <option value="<?= $levelType['id']?>" <?php if (isset($levelId) && $typeId == $levelType['id']) {
                                    ?> selected <?php
                                } ?> > <?= $levelType['title'] ?></option>
                                <?php
                                    }
                                ?>
                              </select>
                          ...
                          <div class="col-md-3 mb-3">
                            <div class="form-group">
                              ...
                              <input type="number" min="0" class="form-control form-control-lg form-control-a" id="inputGarages" name="garages" value="0">
                            </div>
                          </div>
                          <div class="col-md-3 mb-3">
                            <div class="form-group">
                              <label for="inputBedrooms">Спални</label>
                              <input type="number" min="0" class="form-control form-control-lg form-control-a" id="inputBedrooms" name="bedrooms" value="0">
                            </div>
                          </div>
                          <div class="col-md-3 mb-3">
                            <div class="form-group">
                              <label for="inputBathrooms">Бани</label>
                              <input type="number" min="0" class="form-control form-control-lg form-control-a" id="inputBathrooms" name="bathrooms" value="0">
                            </div>
                          </div>
                          <div class="col-md-3 mb-3">
                            <div class="form-group">
                              <label for="inputLivingRooms">Всекидневни</label>
                              <input type="number" min="0" class="form-control form-control-lg form-control-a" id="inputLivingRooms" name="livingRooms" value="0">
                            </div>
                          </div>
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                              <label for="textDescription">Описание</label>
                              <textarea id="textDescription" class="form-control" placeholder="Опишете имота.." name="description" cols="45" rows="8"></textarea>
                            </div>
                          </div> 
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
