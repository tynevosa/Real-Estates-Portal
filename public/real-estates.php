...
$limit = 6;
$offset = ($page - 1) * $limit;
list($count) = $db->first('SELECT COUNT(id) as count from real_estates');
$maxPage = ceil($count / $limit);

$records = $db->fetch('SELECT * from real_estates ORDER BY created_at ' . strtoupper($sort_by_date) . ' LIMIT ' . $limit . ' OFFSET ' . $offset);
?>
<!-- ======= Intro Single ======= -->
    ...
    <div class="row">
      <div class="col-md-12 col-lg-8">
        <div class="title-single-box">
          <h1 class="title-single">Обяви</h1>
